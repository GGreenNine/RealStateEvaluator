...
def build_leaderboard_rows(
    ...
    for rank, record in enumerate(sorted(scored_records, key=_sort_key), start=1):
        ...
        row = {
            ...
            "value_score": (record.get("category_scores") or {}).get("value_score"),
            "technical_risk_score": (record.get("category_scores") or {}).get("technical_risk_score"),
            "transit_score": (record.get("category_scores") or {}).get("transit_score"),
            ...
            "maintenance_fee_per_m2": derived.get("maintenance_fee_per_m2"),
            "building_year": listing.get("building_year"),
            "rooms": derived.get("normalized_rooms") or listing.get("rooms"),
            "building_age_score": hard_scores.get("building_age_score"),
            "plot_ownership_score": hard_scores.get("plot_ownership_score"),
            "price_per_m2_score": hard_scores.get("price_per_m2_score"),
            "size_score": hard_scores.get("size_score"),
            "maintenance_fee_score": hard_scores.get("maintenance_fee_score"),
            "metro_score": hard_scores.get("metro_score"),
            "tram_score": hard_scores.get("tram_score"),
            "rail_score": hard_scores.get("rail_score"),
            "multimodal_bonus": hard_scores.get("multimodal_bonus"),
            "floor_score": hard_scores.get("floor_score"),
            "renovations_score": llm_scores.get("renovations_score"),
